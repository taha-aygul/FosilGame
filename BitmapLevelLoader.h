...
public:
    ...
    /// <summary>
    /// GDI+ baþlatma iþlemi (main fonksiyonunda bir kez çaðýrýlmalý)
    /// </summary>
    ...
    /// </summary>
    static void GenerateLevelFromBitmap(int levelResourceID, int tileSize, HDC hDC, HINSTANCE hInstance);

private:
    /// <summary>
    /// Renk koduna göre ground (zemin) bloðunu oluþturur.
    /// </summary>
    static void CreateGroundTile(int pixelX, int pixelY, int tileSize, HDC hDC, HINSTANCE hInstance);

    /// <summary>
    /// Renk koduna göre ladder (merdiven) bloðunu oluþturur.
    /// </summary>
    static void CreateLadderTile(int pixelX, int pixelY, int tileSize, HDC hDC, HINSTANCE hInstance);

    /// <summary>
    /// Renk koduna göre enemy (düþman) nesnesi oluþturur.
    /// </summary>
    static void CreateEnemyAt(int pixelX, int pixelY, int tileSize, HDC hDC, HINSTANCE hInstance);
