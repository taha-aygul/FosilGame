...
#include "CustomBitmap.h"
    ...
    //-----------------------------------------------------------------
    // CustomBitmap Constructor(s)/Destructor
    //-----------------------------------------------------------------
    ...
    CustomBitmap::CustomBitmap(HDC hDC, LPTSTR szFileName)
        : m_hBitmap(NULL), m_iWidth(0), m_iHeight(0)
    {
    ...
    CustomBitmap::CustomBitmap(HDC hDC, UINT uiResID, HINSTANCE hInstance)
        : m_hBitmap(NULL), m_iWidth(0), m_iHeight(0)
    {
    ...
    CustomBitmap::CustomBitmap(HDC hDC, int iWidth, int iHeight, COLORREF crColor)
        : m_hBitmap(NULL), m_iWidth(0), m_iHeight(0)
    {
    ...
    //-----------------------------------------------------------------
    // CustomBitmap Helper Methods
    //-----------------------------------------------------------------
    void CustomBitmap::Free()
    {
    ...
    //-----------------------------------------------------------------
    // CustomBitmap General Methods
    //-----------------------------------------------------------------
    BOOL CustomBitmap::Create(HDC hDC, LPTSTR szFileName)
    {
    ...
    BOOL CustomBitmap::Create(HDC hDC, UINT uiResID, HINSTANCE hInstance)
    {
    ...
    BOOL CustomBitmap::Create(HDC hDC, int iWidth, int iHeight, COLORREF crColor)
    {
    ...
    void CustomBitmap::Draw(HDC hDC, int x, int y, BOOL bTrans, COLORREF crTransColor)
    {
        DrawPart(hDC, x, y, 0, 0, GetWidth(), GetHeight(), bTrans, crTransColor);
    }

    void CustomBitmap::DrawPart(HDC hDC, int x, int y, int xPart, int yPart,
